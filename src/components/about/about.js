    ...
    return(
      <div className="container" id="outer-container">
        <div className="about" id="page-wrap">
          <h1>About Me</h1>
          <div className="words">
            <p>After completing a degree in Philosophy, I spent three and a half years working for various start ups in wide-reaching, operational roles. I ended up project managing several tech builds which led to a fascination with development.</p>
